...
model, branch_model, head_model = build_model(64e-5, 0.0000)
...
if isfile('../input/w/siamese_epoch-355_loss-0.1753.h5'):
    tmp = keras.models.load_model('../input/w/siamese_epoch-355_loss-0.1753.h5')
    ...
    # epoch -> 150
    # set_lr(model, 4e-5)
    # for _ in range(8): make_steps(5, 0.5)
    # epoch -> 200
    # set_lr(model, 2e-5)
    # for _ in range(3):
    #     make_steps(5, 0.25)
    ...
    set_lr(model, 2e-5)
    for _ in range(5): make_steps(5, 0.25)
    # epoch -> 400
    set_lr(model, 1e-5)
    for _ in range(2): make_steps(5, 0.25)
    model.save('standard512_2.model')
