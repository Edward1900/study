...
weights_path = 'H:/VGG_VOC0712_SSD_300x300_iter_120000.h5'
...
trainval_image_set_filename = 'H:/train.txt'
test_image_set_filename = 'H:/test.txt'
...
model_checkpoint = ModelCheckpoint(filepath='ssd300_mouth_epoch-{epoch:02d}_loss-{loss:.4f}_val_loss-{val_loss:.4f}.h5',
                                   monitor='val_loss',
                                   verbose=1,
                                   save_best_only=True,
...
csv_logger = CSVLogger(filename='ssd300_mouth_training_log.csv',
                       separator=',',
                       append=True)
