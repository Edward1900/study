...
int TF_algorithm::alg_run(cv::Mat img1)
{
	...
	const std::string model_input_name = "input_1";    // 模型文件中的输入名

	std::vector<std::string> model_output_names;
	model_output_names.emplace_back("decoded_predictions/loop_over_batch/TensorArrayStack/TensorArrayGatherV3");
...
{
	// 模型相关参数
	const std::string face_model_path = "inf.pb";
